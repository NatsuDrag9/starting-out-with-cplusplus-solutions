...
int main(void)
{
    ...
    cin >> hours;
    cout << "Enter full name of the month: ";
    cin >> monthName;
    ...
    if (((monthName == "January") || (monthName == "March") || (monthName == "May") || (monthName == "July") || (monthName == "August") || (monthName == "October") || (monthName == "December")) && (hours > 744))
    {
        cout << "Invalid input! Hours cannot exceed 744 in " << monthName << " .Exiting.." << endl;
        return 0;
    }
    else if (((monthName == "April") || (monthName == "June") || (monthName == "September") || (monthName == "Movember")) && (hours > 720))
    {
        cout << "Invalid input! Hours cannot exceed 720 in " << monthName << " . Exiting.." << endl;
        return 0;
    }
    else if ((monthName == "February") && (hours > 672))
    {
        cout << "Invalid input! Hours cannot exceed 672 in " << monthName <<" . Exiting.." << endl;
        return 0;
    }
    else {
        cout << "Invalid input! Enter correct month name" << endl;
        return 0;
    }
