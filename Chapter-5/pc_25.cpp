...
int main(void)
{
    ...
    cout << "Total deposits made during three months (in ₹): " << depositMonth1 + depositMonth2 + depositMonth3 << endl;
    cout << "Total withdrawls made during three months (in ₹): " << withdrawlMonth1 + withdrawlMonth2 + withdrawlMonth3 << endl;
    cout << "Total interest posted to the account during three months (in ₹): " << interestMonth1 + interestMonth2 + interestMonth3 << endl;
    cout << "Final balance (in ₹): " << balance << endl;
